  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        Eu sou {selected?.label || "..."}
      </button>

      {isOpen && (
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-[#1a1a2e] border border-white/20 rounded-xl shadow-2xl overflow-hidden min-w-[200px] z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
